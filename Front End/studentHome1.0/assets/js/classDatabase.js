...
function class_() {
	this.classID; // string
	this.name;  //string
	this.teacher; //string teacher name
}
var urClass =[]; 
var allClass =[]; 
...
class1.classID = '5251';
class1.name = 'ECO1';
class1.teacher ='Paul Donji';
urClass.push(class1);
allClass.push(class1);

var class2 = new class_();
class2.classID = '4512';
class2.name = 'PHY3';
class2.teacher ='Paul Donji';
urClass.push(class2);
allClass.push(class2);

var class3 = new class_();
class3.classID = '1025';
class3.name = 'BIO2';
class3.teacher ='Paul Donji';
urClass.push(class3);
allClass.push(class3);

var class4 = new class_();
class4.classID = '7910';
class4.name = 'MTE4';
class4.teacher ='Paul Donji';
urClass.push(class4);
allClass.push(class4);
...
{	
    ...
    var possible = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	for( var i=0; i < 10; i++ )
        teacher += possible.charAt(Math.floor(Math.random() * possible.length));
    return teacher;
}
